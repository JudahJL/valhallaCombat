...
namespace Hooks {
    ...
    public:
        static void install() {
            ...
            REL::Relocation<uintptr_t> hook{ RELOCATION_ID(37'650, 38'603) };  //SE:627930 + 16E => 3BEC90 AE:64D350 + 171 => 3D6720

            _getAttackStaminaCost = trampoline.write_call<5>(hook.address() + RELOCATION_OFFSET(0x1'6E, 0x1'71), getAttackStaminaCost);
    ...
    public:
        static void install() {
            REL::Relocation<uintptr_t> hook{ RELOCATION_ID(37'510, 38'452) };  // 140620690       140645AA0
            auto&                      trampoline = SKSE::GetTrampoline();
    ...
    public:
        static void install() {
            REL::Relocation<uintptr_t> hook{ RELOCATION_ID(37'510, 38'452) };  // 140620690       140645AA0
            auto&                      trampoline = SKSE::GetTrampoline();
            _RestoreActorValue                    = trampoline.write_call<5>(hook.address() + RELOCATION_OFFSET(0x1'76, 0xE1), RestoreActorValue);
    ...
    public:
        static void install() {
            REL::Relocation<uintptr_t> hook{ RELOCATION_ID(37'673, 38'627) };  //140628C20       14064E760
            auto&                      trampoline = SKSE::GetTrampoline();
            _ProcessHit                           = trampoline.write_call<5>(hook.address() + RELOCATION_OFFSET(0x3'C0, 0x4'A8), processHit);
    ...
    public:
        static void install() {
            REL::Relocation<uintptr_t> hook{ RELOCATION_ID(37'650, 38'603) };  //SE:627930 + 38B AE:64D350 +  45A
            auto&                      trampoline = SKSE::GetTrampoline();

            _ProcessHit = trampoline.write_call<5>(hook.address() + RELOCATION_OFFSET(0x3'8B, 0x4'5A), processHit);
    ...
    public:
        static void install() {
            REL::Relocation<uintptr_t> hook{ RELOCATION_ID(37'376, 00000) };
            auto&                      trampoline = SKSE::GetTrampoline();
    ...
    public:
        static void install() {
            auto&                           trampoline = SKSE::GetTrampoline();
            REL::Relocation<std::uintptr_t> AttackActionBase{ RELOCATION_ID(48'139, 49'170) };
            _PerformAttackAction = trampoline.write_call<5>(AttackActionBase.address() + RELOCATION_OFFSET(0x4'D7, 0x4'35), PerformAttackAction);
