...
public:
    ...
    void activateUpdate(HANDLER a_ValhallaHandler) {
        switch(a_ValhallaHandler) {
            case ValhallaCombat::debuffHandler:
                update_DebuffHandler = true;
                break;
            case ValhallaCombat::blockHandler:
                update_BlockHandler = true;
                break;
            case ValhallaCombat::stunHandler:
                update_StunHandler = true;
                break;
    ...
    void deactivateUpdate(HANDLER a_ValallaHandler) {
        switch(a_ValallaHandler) {
            case ValhallaCombat::debuffHandler:
                update_DebuffHandler = false;
                break;
            case ValhallaCombat::blockHandler:
                update_BlockHandler = false;
                break;
            case ValhallaCombat::stunHandler:
                update_StunHandler = false;
                break;
