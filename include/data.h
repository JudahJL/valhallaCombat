...
public:
    ...
    const static inline std::string AnimEvent_GuardCounter =
        "Val_GuardCounter_Trigger";
    const static inline std::string GraphBool_IsGuardCountering =
        "is_Guard_Countering";
...
#pragma region ExecutionIdles
    ...
    static inline KM KM_Humanoid_H2H;
    static inline KM KM_Humanoid_Dagger;
    static inline KM KM_Humanoid_Sword;
    static inline KM KM_Humanoid_Axe;
    static inline KM KM_Humanoid_Mace;
    static inline KM KM_Humanoid_GreatSword;
    static inline KM KM_Humanoid_2hw;
    static inline KM KM_Humanoid_DW;
    static inline KM KM_Humanoid_1hm_Back;
    static inline KM KM_Humanoid_2hm_Back;
    static inline KM KM_Humanoid_H2H_Back;
    static inline KM KM_Humanoid_2hw_Back;
    static inline KM KM_Falmer_1hm;
    static inline KM KM_Falmer_2hm;
    static inline KM KM_Falmer_2hw;
    static inline KM KM_Undead_1hm;
    static inline KM KM_Undead_2hm;
    static inline KM KM_Undead_2hw;
    static inline KM KM_Spider_1hm;
    static inline KM KM_Spider_2hm;
    static inline KM KM_Spider_2hw;
    static inline KM KM_Gargoyle_1hm;
    static inline KM KM_Gargoyle_2hm;
    static inline KM KM_Gargoyle_2hw;
    static inline KM KM_Giant_1hm;
    static inline KM KM_Giant_2hm;
    static inline KM KM_Giant_2hw;
    static inline KM KM_Bear_1hm;
    static inline KM KM_Bear_2hm;
    static inline KM KM_Bear_2hw;
    static inline KM KM_SabreCat_1hm;
    static inline KM KM_SabreCat_2hm;
    static inline KM KM_SabreCat_2hw;
    static inline KM KM_Wolf_1hm;
    static inline KM KM_Wolf_2hm;
    static inline KM KM_Wolf_2hw;
    static inline KM KM_Troll_1hm;
    static inline KM KM_Troll_2hm;
    static inline KM KM_Troll_2hw;
    static inline KM KM_Hagraven_1hm;
    static inline KM KM_Hagraven_2hm;
    static inline KM KM_Hagraven_2hw;
    static inline KM KM_Spriggan_1hm;
    static inline KM KM_Spriggan_2hm;
    static inline KM KM_Spriggan_2hw;
    static inline KM KM_Boar_1hm;
    static inline KM KM_Boar_2hm;
    static inline KM KM_Boar_2hw;
    static inline KM KM_Riekling_1hm;
    static inline KM KM_Riekling_2hm;
    static inline KM KM_Riekling_2hw;
    static inline KM KM_AshHopper_1hm;
    static inline KM KM_AshHopper_2hm;
    static inline KM KM_AshHopper_2hw;
    static inline KM KM_Centurion_1hm;
    static inline KM KM_Centurion_2hm;
    static inline KM KM_Centurion_2hw;
    static inline KM KM_Ballista_1hm;
    static inline KM KM_Ballista_2hm;
    static inline KM KM_Ballista_2hw;
    static inline KM KM_ChaurusFlyer_1hm;
    static inline KM KM_ChaurusFlyer_2hm;
    static inline KM KM_ChaurusFlyer_2hw;
    static inline KM KM_Lurker_1hm;
    static inline KM KM_Lurker_2hm;
    static inline KM KM_Lurker_2hw;
    static inline KM KM_Dragon_1hm;
    static inline KM KM_Dragon_2hm;
    static inline KM KM_Dragon_2hw;
...
#pragma region ExecutionRaces
    ...
    static inline std::unordered_map<RE::TESRace*, raceCatagory>
                raceMapping;
    /*Look up the actor from race mapping, and return whether the actor belongs to
  a race catagory.
...
private:
    ...
    static inline const char* kmRaceDir =
        "Data/SKSE/Plugins/ValhallaCombat/RaceMapping";
    /*Path of file storing all killmoves.*/
    static inline const char* kmFilePath =
        R"(Data\SKSE\Plugins\ValhallaCombat\Killmoves.ini)";

    /*Lookup an idle from a certain esp, and store it in an idleContainer. Errors
  if the idle does not exist.
  ...
  @return Whether the idle exists and therefore can be loaded or not.*/
    static bool lookupIdle(RE::TESDataHandler* DATA, RE::FormID form,
  ...
  @param section: a simpleIni's section, in string, to be loaded.*/
    static void loadIdleSection(RE::TESDataHandler*            DATA,
                                std::vector<RE::TESIdleForm*>* idleContainer,
    ...
    /*Read race from the plugin, and map it to an execution type through
  ExecutionRaceMap.
  @param DATA: pointer to TESDataHandler's singleton.
  ...
  @return If the race form exists or not.*/
    static bool pairUpRace(RE::TESDataHandler* DATA, RE::FormID form,
                           std::string pluginName, raceCatagory raceType);

    /*Load a simpleIni section storing a set of races belonging to that section's
  corresponding killmove.
  @param DATA: pointer to TESDataHandler's singleton.
  @param raceType: type of the execution race to be mapped to.
  @param ini: ini whose section to load.
  @param section: a simpleIni's section, in string, to be loaded.*/
    static void loadRaceSection(RE::TESDataHandler* DATA, raceCatagory raceType,
                                CSimpleIniA& ini, const char* section);

    /*Load a simpleIni file storing mapping of executable races.*/
    static void loadExecutableRaceIni(RE::TESDataHandler* DATA,
                                      const char*         ini_path);
...
namespace inlineUtils {
    ...
    static std::vector<std::string> tokenize(const std::string& delimiter,
    ...
    static bool ToInt32(std::string str, int& value) {
        ...
        char*       endVal = nullptr;
        const long  ret    = strtol(strVal, &endVal, 0);
