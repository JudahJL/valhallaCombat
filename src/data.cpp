...
void data::loadSound(RE::TESDataHandler* a_data) {
    ...
    loader.load(soundParryShield, 0x43'3c);
    loader.load(soundParryShield_perfect, 0x6'0c'2e);
    loader.load(soundParryShield_gb, 0X4'77'20);
    loader.load(soundParryWeapon, 0X3D'D9);
    loader.load(soundParryWeapon_perfect, 0X6'0C'2D);
    loader.load(soundParryWeapon_gb, 0X4'77'21);
    loader.load(soundStunBreak, 0X5'6A'22);
    loader.load(soundTackleStart, 0x6'0c'36);
    logger::info("...done");
}
...
void data::loadPerk(RE::TESDataHandler* a_data) {
    ...
    DtryUtils::formLoader loader("ValhallaCombat.esp");
    loader.load(debuffPerk, 0x2D'B2);
    logger::info("...done");
}
...
void data::loadBlockFX(RE::TESDataHandler* a_data) {
    ...
    DtryUtils::formLoader loader("ValhallaCombat.esp");
    loader.load(BlockFX, 0x6'0c'2f);
    loader.load(BlockSpark, 0x6'0c'30);
    loader.load(BlockSparkFlare, 0x6'0c'31);
    loader.load(BlockSparkRing, 0x6'0c'32);
    logger::info("...done");
}
